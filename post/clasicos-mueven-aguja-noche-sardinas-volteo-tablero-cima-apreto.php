...
$page_title = "Sardiñas mueve la cima en una noche de clásicos decisivos";  // De [HEAD] TituloDocumento
$og_type = "article";  // De [HEAD] OgType (fijo)
$og_title = "Sardiñas mueve la cima en una noche de clásicos decisivos";  // De [HEAD] TituloDocumento
...
$og_image = rtrim(SITE_URL, '/') . "/assets/img/clasicos-mueven-aguja-noche-sardinas-volteo-tablero-cima-apreto.webp";  // De [HEAD] OgImage (ajustar ruta)
...
$twitter_image = rtrim(SITE_URL, '/') . "/assets/img/clasicos-mueven-aguja-noche-sardinas-volteo-tablero-cima-apreto.webp";  // De [HEAD] TwitterImage (ajustar ruta)
