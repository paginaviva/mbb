...
<div class="home-grid-container-desktop">
    ...
    <!-- BLOQUE A: La jornada de ayer -->
    <?php if (!empty($home_data['block_a']['latest']) || !empty($home_data['block_a']['others'])): ?>
        <section id="block-yesterday-desktop" class="home-block-desktop">

            <!-- Último Post -->
            <?php if (!empty($home_data['block_a']['latest'])):
                $latest = $home_data['block_a']['latest'];
            ?>
                <div class="block-title-desktop">La jornada de ayer</div>
            ...
            <?php if (!empty($home_data['block_a']['others'])): ?>
                <div class="block-title-desktop mt-4">Otras Jornadas</div>
                <ul class="post-list-small-desktop">
