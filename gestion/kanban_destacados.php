...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'save') {
    ...
    if (is_array($featured_ids) && count($featured_ids) <= 10) {
        $data_to_save = [
            'updated_at' => time(),
            'ids' => $featured_ids,
        ...
        if ($write_result !== false) {
            ...
            header('Content-Type: application/json');
            echo json_encode(['success' => false, 'message' => 'Máximo 10 artículos permitidos']);
            exit;
        }
    } else {
        header('Content-Type: application/json');
        ...
        <div class="kanban-container">
            ...
            <div class="kanban-column" id="featured">
                <div class="kanban-column-header">
                    ...
                    <span class="counter-badge" id="featured-counter">0/10</span>
                </div>
    ...
    <script>
        ...
        new Sortable(featuredList, {
            ...
            onAdd: function(evt) {
                ...
                if (featuredList.children.length > 10) {
                    alert('⚠️ Máximo 10 artículos destacados permitidos');
                    // Mover de vuelta
        ...
        function updateCounters() {
            ...
            featuredCounter.textContent = featuredCount + '/10';
        ...
        function saveChanges() {
            ...
            if (featuredIds.length > 10) {
                alert('⚠️ No se puede guardar: máximo 10 artículos destacados');
                return;
            }
